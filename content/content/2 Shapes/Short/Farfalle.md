...
- [Black Pepper Dough](Black%20Pepper%20Dough.md)
- [Chestnut Dough](Chestnut%20Dough.md)
- [Citrus-Scented Dough](Citrus-Scented%20Dough.md)
- [Colorful Egg Dough](Colorful%20Egg%20Dough.md) /[Patterned Sheet](Patterned%20Sheet.md)
...
There are many ways to make farfalle. Here’s what works best for me:
Hold a rectangle between your thumbs (in front) and index fingers (at the back), with the shorter, fluted edges at top and bottom. Start folding the rectangle inward like a book and then, just as your thumbs start to knock against each other, use them to peel the center part of the side edges back, away from you, so it starts to look like a butterfly (or bow tie). Pinch the center firmly to seal, then fan out the wings a little bit more.
